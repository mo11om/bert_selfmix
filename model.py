...
class Bert4Classify(nn.Module):
    def __init__(self, pretrained_model_name_or_path, dropout_rate, num_classes):
        ...
        ###  need to resize embeddings if tokenizer is changed
        self.encoder.resize_token_embeddings(len(self.encoder.embeddings.word_embeddings.weight)+3)  # Resize for custom tokens if needed
        ###
